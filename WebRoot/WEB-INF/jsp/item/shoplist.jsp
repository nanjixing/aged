...
<%--    这里get请求参数一致同样也会自动映射--%>
    ...
    <a href="${ctx}/item/shoplist?gmNum=1&categoryIdTwo=${obj.categoryIdTwo}&condition=${condition}" class="mR">
        销量
        <img src="${ctx}/resource/user/images/gg.png" alt="">
    </a>
...
<div id="navs">
    <div class="pagelist">
        <!--分页开始-->
        <pg:pager url="${ctx}/item/shoplist" maxIndexPages="5" items="${pagers.total}" maxPageItems="5" export="curPage=pageNumber">
