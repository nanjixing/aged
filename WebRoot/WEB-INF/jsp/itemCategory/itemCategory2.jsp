...
<%--        循环遍历后台传入的model中的pagers中的数据--%>
        ...
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!--分页开始访问路径，pg是jsp标签库实现分页的一个工具-->
                    <pg:pager url="${ctx}/itemCategory/findBySql2" maxIndexPages="5" items="${pagers.total}" maxPageItems="5" export="curPage=pageNumber">
                        <pg:param name="pid" value="${obj.pid}" />
                        <pg:last>
