...
public abstract  class BaseServiceImpl<T> implements BaseService<T>{
    ...
    //通过在子类中用getBaseDao为父类中的baseDao赋值
	 ...
	 * @param entity
	 */
	public void updatePay(Pay entity) {
		this.getBaseDao().updatePay(entity);
	}
	...
	public Pager<T> findByMap(Map<String, Object> params) {
		...
		if(pageSize==null||pageSize<0 || pageSize > 5) pageSize = 5;
